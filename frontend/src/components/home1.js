            ...
            <body id="top">
                ...
                <header class="header" data-header>
                    <div class="container">
                        ...
                        <a href="/traineelogin" class="btn btn-secondary">LOGIN</a>
                        ...
                        <section class="section hero bg-dark has-after has-bg-image" id="home" aria-label="hero" data-section
                            ...
                            <div class="container">
                                ...
                                <div class="hero-content">
                                    ...
                                    <a href="#Subscription" class="btn btn-primary">Get Started</a>

                                </div>

                                <div class="hero-banner">
                                    <img src={require('../assets/images/hero-banner.png')} width="1000" height="900" alt="hero banner" class="w-100" />
                        ...
                        <div class="container">
                            ...
                            <div class="footer-brand">
                                ...
                                <div class="wrapper">
                                    ...
                                    <a href="/trainer" class="btn btn-secondary">Trainer</a>
                                </div>
