                                ...
                                <div className="card chat dz-chat-history-box d-none">
                                    <div className="card-header chat-list-header text-center">
                                        ...
                                        <div className="dropdown">
                                            <a href="javascript:void(0)" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></a>
                                            ...
                                            <li className="active">
                                                <div className="d-flex bd-highlight">
                                                    ...
                                                    <div className="ml-auto">
                                                        <a href="javascript:void(0)" className="btn btn-primary btn-xs sharp mr-1"><i className="fa fa-pencil" /></a>
                        ...
                        <nav className="navbar navbar-expand">
                            <div className="collapse navbar-collapse justify-content-between">
                                ...
                                <ul className="navbar-nav header-right">
                                    ...
                                    <li className="nav-item dropdown notification_dropdown">
                                        <a className="nav-link" href="javascript:void(0)" data-toggle="dropdown">
                                            <svg width={28} height={28} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="deznav">
                    <div className="deznav-scroll">
                        ...
                        <div className="copyright">
                            ...
                            <p>Made with <span className="heart" /> by DexignZone</p>
                        </div>
                    </div>
                </div>
                {/***********************************
                                    ...
                                    <div className="col-xl-12">
                                        <div className="card">
                                            <div className="card-header flex-wrap border-0 pb-0">
                                                ...
                                                <a href="workout-statistic.html" className="btn btn-outline-light btn-rounded">Set Target</a>
                                            </div>
                                                    ...
                                                    <div className="col-lg-8">
                                                        <div className="row">
                                                            <div className="col-sm-6">
                                                                <div className="d-flex align-items-center mb-sm-5 mb-3">
                                                                    <div className="d-inline-block relative donut-chart-sale mr-3">
                                                                        <span className="donut" data-peity="{ &quot;fill&quot;: [&quot;rgb(160, 44, 250)&quot;, &quot;rgba(236, 236, 236, 1)&quot;],   &quot;innerRadius&quot;: 34, &quot;radius&quot;: 10}">2/8</span>
                                                                        <small>
                                                                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div className="col-sm-6">
                                                                <div className="d-flex align-items-center mb-sm-5 mb-3">
                                                                    <div className="d-inline-block relative donut-chart-sale mr-3">
                                                                        <span className="donut" data-peity="{ &quot;fill&quot;: [&quot;rgb(255, 188, 17)&quot;, &quot;rgba(236, 236, 236, 1)&quot;],   &quot;innerRadius&quot;: 34, &quot;radius&quot;: 10}">8/10</span>
                                                                        <small>
                                                                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div className="col-sm-6">
                                                                <div className="d-flex align-items-center mb-sm-0 mb-3">
                                                                    <div className="d-inline-block relative donut-chart-sale mr-3">
                                                                        <span className="donut" data-peity="{ &quot;fill&quot;: [&quot;rgb(255, 50, 130)&quot;, &quot;rgba(236, 236, 236, 1)&quot;],   &quot;innerRadius&quot;: 34, &quot;radius&quot;: 10}">5/8</span>
                                                                        <small>
                                                                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div className="col-sm-6">
                                                                <div className="d-flex align-items-center mb-sm-0 mb-3">
                                                                    <div className="d-inline-block relative donut-chart-sale mr-3">
                                                                        <span className="donut" data-peity="{ &quot;fill&quot;: [&quot;rgb(130, 190, 101)&quot;, &quot;rgba(236, 236, 236, 1)&quot;],   &quot;innerRadius&quot;: 34, &quot;radius&quot;: 10}">7/8</span>
                                                                        <small>
                                                                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
